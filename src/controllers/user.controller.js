...
const changeCurrentPassword = asynchandler(async (req, res) => {
    ...
    if (!(newPassword === confPassword)) {
        throw new ApiError(401,"Password typing error")
    }
...
const updateUserAvatar = asynchandler(async (req, res) => {
    const avatarLocalPath = req.file?.path// This we have taken from multer so 
    if (!avatarLocalPath) {
...
const getUserChannelProfile = asynchandler(async (req, res) => {
    ...
    // console log channel what data does aggregate returns
...
const getWatchHistory = asynchandler(async (req, res) => {
    // in mongo db the id is in string so what mongoose does is that it automatically converts mongoDb id to string
    // req.user._id  this gives string
